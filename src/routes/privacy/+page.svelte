...
<section class="bg-white dark:bg-gray-900 py-8 px-4 lg:py-16 lg:px-12">
    ...
    NOMBRE_DE_LA_EMPRESA S.A. (en adelante, "NOMBRE_DE_LA_EMPRESA") respeta su preocupación por la privacidad. Esta política
			...
			incluye la información denominada "información de identificación personal", "información
			personal" o "datos personales" en virtud de las leyes de privacidad de datos aplicables,
			...
			tendrán el significado que se les da en las Condiciones de Uso.
		</p>
			...
			<div class="pt-2 grid-cols-2 text-left md:gap-16">
				<div>
					<div class="mb-20">
						...
						>
							Recopilamos su información personal con el fin de proporcionar y mejorar continuamente
							nuestros productos y servicios. Estos son los tipos de información personal que
							recopilamos:
						</p>
						<br />
						...
						<ul class="space-y-1 list-disc list-inside text-gray-500 dark:text-gray-400">
							...
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white"
									>Información de otras fuentes</strong
								>: Es posible que recibamos información sobre usted de otras fuentes, como
								información actualizada de entrega y dirección de nuestros transportistas, que
								usamos para corregir nuestros registros y entregar su próxima compra más fácilmente.
							</li>
						</ul>
					</div>
					<div class="mb-20">
						...
						<p
							class="pt-4 text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700"
						>
							Utilizamos su información personal para operar, proporcionar, desarrollar y mejorar
							los productos y servicios que ofrecemos a nuestros clientes. Estos fines incluyen:
						</p>
						<br />
						<ul class="space-y-1 list-disc list-inside text-gray-500 dark:text-gray-400">
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white"
									>Compra y entrega de productos y servicios</strong
								>. Usamos su información personal para tomar y manejar pedidos, entregar productos y
								servicios, procesar pagos y comunicarnos con usted acerca de pedidos, productos y
								servicios, y ofertas promocionales.
							</li>
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white"
							...
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white"
									>Proporcionar servicios de voz, imagen y cámara</strong
								>. Cuando utiliza nuestros servicios de voz, imagen y cámara, utilizamos su entrada
								de voz, imágenes, vídeos y otra información personal para responder a sus
								solicitudes, proporcionarle el servicio solicitado y mejorar nuestros servicios.
							</li>
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white"
									>Cumplir con las obligaciones legales</strong
								>. En algunos casos, recopilamos y utilizamos su información personal para cumplir
								con las leyes.
							</li>
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white"
							...
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white">Publicidad</strong>.
								Utilizamos su información personal para mostrar anuncios basados en intereses de
								características, productos y servicios que puedan ser de su interés. No utilizamos
								información que lo identifique personalmente para mostrar anuncios basados en
								intereses.
							</li>
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white"
					...
					<div class="mb-20">
						<h3 class="flex items-center mb-4 text-2xl font-medium text-gray-900 dark:text-white">
							<svg
								...
								/></svg
							>
							¿Qué pasa con las cookies y otros identificadores?
						</h3>
						<p
							class="pt-4 text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700"
						>
					...
					<div class="mb-20">
						...
						<ul class="space-y-1 list-disc list-inside text-gray-500 dark:text-gray-400">
							...
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white"
									>Proveedores de servicios externos</strong
								>: Empleamos a otras empresas e individuos para realizar funciones en nuestro
								nombre. Por ejemplo, empleamos a otras empresas e individuos para realizar funciones
								en nuestro nombre, como despachar pedidos de productos o servicios, entregar
								paquetes, enviar correo postal y correo electrónico, eliminar información repetitiva
								de las listas de clientes, analizar datos, brindar asistencia de marketing,
								proporcionar resultados de búsqueda y enlaces, procesar pagos, transmitir contenido
								y proporcionar servicio al cliente. Estos proveedores de servicios de terceros
								tienen acceso a cierta información personal necesaria para realizar sus funciones,
								pero no pueden utilizarla para otros propósitos.
							</li>
							<li>
								<strong class="font-semibold text-gray-900 dark:text-white"
									>Transferencias de negocios</strong
								>: A medida que continuamos desarrollando nuestro negocio, podríamos vender o
								comprar otros negocios o servicios. En dichas transacciones, la información de los
					...
					<div class="mb-20">
						...
						<p
							class="pt-4 text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700"
						>
							Diseñamos nuestros sistemas y dispositivos teniendo en cuenta tu seguridad y
							privacidad.
						</p>
						<br />
						<ul class="space-y-1 list-disc list-inside text-gray-500 dark:text-gray-400">
							<li>
								Trabajamos para proteger la seguridad de su información personal durante la
								transmisión mediante el uso de protocolos de cifrado y software.
							</li>
							<li>
								Mantenemos medidas de seguridad físicas, electrónicas y de procedimiento en relación
								con la recopilación, almacenamiento y divulgación de información personal del
								cliente. Nuestros procedimientos de seguridad implican que, solicitamos verificar su
								identidad antes de que te revelemos información personal para asegurarnos de que
								eres quien dices ser. Sin embargo, por desgracia, no se puede garantizar al 100% la
								seguridad de ninguna transmisión de datos por Internet. Como resultado, aunque nos
								esforzamos por proteger su información de contacto, en la medida permitida por la
								ley, no garantizamos ni aseguramos la seguridad de ninguna información que usted
								transmita a o desde nuestro Sitio Web, y usted lo hace bajo su propia
								responsabilidad.
							</li>
							<li>
					...
					<div class="mb-20">
						...
						<p
							class="pt-4 text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700"
						>
							Puede acceder a su información, incluyendo tu nombre, dirección, opciones de pago,
							información de perfil, membresía, configuración del hogar y historial de compras en la
							sección "Mi cuenta" del sitio web.
						</p>
					</div>
					<div class="mb-20">
						<h3 class="flex items-center mb-4 text-2xl font-medium text-gray-900 dark:text-white">
            ...
            NOMBRE_DE_LA_EMPRESA.com no comercializa productos para ser adquiridos por menores de edad.
					...
					<div class="mb-20">
						...
						>
							...
							indique lo contrario, nuestro Aviso de Privacidad actual será aplicable a toda la
							información que tenemos referente a usted y a su cuenta. No obstante, somos fieles a
							nuestra palabra y en ningún caso modificaremos sustancialmente nuestras políticas ni
							prácticas para hacerlas menos eficaces en la protección de los datos personales de
							nuestros clientes recabados en el pasado sin el consentimiento previo de los clientes
							afectados.
						</p>
					</div>
				</div>
